...
class CppExecutor {
  constructor() {
    this.compiler = config.compilers.cpp.compiler;
    this.flags = config.compilers.cpp.flags;
    this.outputName = config.compilers.cpp.outputName;
  }
...
export default new CppExecutor();
